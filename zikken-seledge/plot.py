...
for i in range(0, int(mincount*0.05)):
    xvalues.append(i)
...
# fig=plt.figure()
# ax=fig.add_subplot(111, xlabel= "number of serches", ylabel="score")
# ax.plot(xvalues, convert2(hill_his, xvalues), marker="o", label="hillclimbing", markersize=3)
# ax.legend()
# ax.plot(xvalues, convert2(dir1_his, xvalues), marker="x", label="directed1", markersize=3)
# ax.legend()
# ax.plot(xvalues, convert2(dir2_his, xvalues), marker="o", label="directed2", markersize=3)
# ax.legend()
