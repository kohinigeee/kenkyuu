...
Graph divideAnnealing(int groups, int r, vector<pair<int,int>>& values, vector<int>& ports, pair<Edge,Edge> (*select)(Graph&, mt19937&), int frees = 0) {
    ...
    for ( int i = 0; i < groups; ++i ) {
        ...
        Graph best = annealing(graph, params, select);
    ...
    Graph best = annealing(upper, param, select);
